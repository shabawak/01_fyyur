...
def venues():
  ...
  # Using set() to build unique elements in order to prevent   duplicate venues
  locations = set()
  ...
  for venue in venues:
    ...
    # getting the  current date to filter the number of upcoming shows
    ...
    #looping through the venue location in the data[]
...
def delete_venue(venue_id):
  ...
  try:
    ...
    db.session.commit()
    # on successful venue delete, flash successfully deleted
    flash('Venue ' + venue_name + ' was deleted')
  except:
    # on unsuccessful venue delete, flash error
...
def search_artists():
  ...
  # filtering the  artists by  search term(case insensitive)
...
def show_artist(artist_id):
  ...
  upcoming_shows = []
  current_time = datetime.now()
  # filtering the  shows by the upcoming and past shows
...
def edit_artist_submission(artist_id):
  ...
  try:
    ...
    db.session.commit()
    # on successful artist update, flash success
    flash('The Artist ' + request.form['name'] + ' has been successfully updated!')
  except:
    db.session.rollback()
    # on unsuccessful update, flash error
...
def edit_venue_submission(venue_id):
  ...
  try:
    ...
    db.session.commit()
    flash('Venue ' + name + 'has been updated successfully')
  except:
    db.session.rollback()
    flash('An error occurred when updating the Venue')
  finally:
    db.session.close()
